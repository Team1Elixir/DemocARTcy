  ...
  return (
    <div className="container-fluid d-flex justify-content-center align-items-center mb-3" style={{ marginTop: 75 }}>
      <div className="w-100 row">
        ...
        <div className="col-4 d-flex flex-column justify-content-start w-100 work-desc p-5 align-items-center">
          <p className="work-creator mb-5">
            Creator: <Link to={'/profile/'+work.username}>
              <span className="creator-name">{work.username}</span>
            </Link>
          </p>
