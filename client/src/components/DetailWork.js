...
const DetailWork = () => {
  return (
    <div className="container-fluid d-flex justify-content-center align-items-center" style={{marginTop: 50}}>
      <div className="w-100 row">
        ...
        <div className="col-4 d-flex flex-column justify-content-start w-100 work-desc p-5">
          <p className="work-creator mb-5 text-center">Creator: <span>Hueyguey</span></p>
          <p className="work-title mb-5 text-center">Doodle Art</p>
